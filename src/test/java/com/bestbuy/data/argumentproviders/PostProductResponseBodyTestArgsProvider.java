...
import com.bestbuy.data.api.response.models.errors.PostRequestErrorResponseBody;
...
public class PostProductResponseBodyTestArgsProvider implements ArgumentsProvider {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        new Product.Builder()
                                ...
                                .setImage("some image")
                                .build(),
                        PostRequestErrorResponseBody.class
                ),
                Arguments.of(
